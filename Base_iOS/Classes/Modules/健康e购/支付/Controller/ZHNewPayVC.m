...
//        
//        CGFloat x = 85;
//        _tradePwdTf = [[TLTextField alloc] initWithFrame:CGRectMake(x, 1, kScreenWidth - x, 47)];
...
//        infoCell.infoLbl.attributedText = self.amoutAttr;
        infoCell.infoLbl.text = [NSString stringWithFormat:@"￥%@", [_rmbAmount convertToRealMoney]];
