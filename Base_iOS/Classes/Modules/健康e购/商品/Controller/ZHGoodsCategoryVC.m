...
- (void)viewDidLoad {
    ...
    //下部
    self.switchScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, self.smallChooseScrollView.yy, kScreenWidth, kSuperViewHeight - kTabBarHeight - smallChooseView.yy)];
