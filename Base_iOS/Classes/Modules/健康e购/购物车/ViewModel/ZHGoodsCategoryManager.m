...
- (void)getAllCategory {
    ...
    [http postWithSuccess:^(id responseObject) {
        ...
        NSArray <ZHCategoryModel *>*data = [ZHCategoryModel mj_objectArrayWithKeyValuesArray:responseObject[@"data"]] ;
...
- (void)getBigCategory {
    ...
    [http postWithSuccess:^(id responseObject) {
        ...
        self.bigCategories = [ZHCategoryModel mj_objectArrayWithKeyValuesArray:category];
...
- (void)getDSHJCategory {
    ...
    [http postWithSuccess:^(id responseObject) {
     ...
     self.dshjCategories = [ZHCategoryModel mj_objectArrayWithKeyValuesArray:category];
...
- (void)getZeroBuyCategory {
    ...
    [http postWithSuccess:^(id responseObject) {
        ...
        self.lysgCategories = [ZHCategoryModel mj_objectArrayWithKeyValuesArray:category];
