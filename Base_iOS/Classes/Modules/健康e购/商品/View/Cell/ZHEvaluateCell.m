...
//        self.evaluateLbl.clipsToBounds = YES;
        ...
        //
        self.nameLbl = [UILabel labelWithFrame:CGRectMake(self.avatar.xx + 23,0, kScreenWidth - self.avatar.xx - 100, [[self class] rowHeight])
...
- (void)setEvaluateModel:(ZHEvaluateModel *)evaluateModel {
    ...
    if ([evaluateModel.photo isKindOfClass:[NSNull class]]) {
        ...
        [self.avatar sd_setImageWithURL:[NSURL URLWithString:[evaluateModel.photo convertImageUrl]] placeholderImage:[UIImage imageNamed:@"user_placeholder"]];
