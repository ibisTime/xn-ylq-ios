...
- (UIView *)progressView {
    ...
    if (!_progressView) {
        ...
        _progressView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 50)];
        ...
        //
        self.alreadlyLbl = [UILabel labelWithFrame:CGRectMake(evaluateView.xx, 0, kScreenWidth - evaluateView.xx - 15, _progressView.height)
