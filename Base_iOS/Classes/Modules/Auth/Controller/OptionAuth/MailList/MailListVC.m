...
- (void)initSubview {
    ...
    UIButton *authBtn = [UIButton buttonWithTitle:@"马上授权" titleColor:kWhiteColor backgroundColor:kAppCustomMainColor titleFont:15 cornerRadius:22.5];
    ...
    //温馨提示
    UILabel *promptLbl = [UILabel labelWithText:@"" textColor:kTextColor2 textFont:13.0];
