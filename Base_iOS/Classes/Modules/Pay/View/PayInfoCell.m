...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.selectedBtn setBackgroundImage:[UIImage imageNamed:@"pay_unselected"] forState:UIControlStateNormal];
...
- (void)setPay:(PayFuncModel *)pay {
    ...
    if (_pay.isSelected) {
        ...
        [self.selectedBtn setImage:[UIImage imageNamed:@"pay_selected"] forState:UIControlStateNormal];
    }
...
- (void)payChange:(NSNotification *)notification {
    ...
    if ([obj isEqual:self]) {
        ...
        [self.selectedBtn setImage:[UIImage imageNamed:@"pay_unselected"] forState:UIControlStateNormal];
