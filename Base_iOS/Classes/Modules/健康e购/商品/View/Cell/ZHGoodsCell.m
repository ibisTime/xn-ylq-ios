...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        //名称
        self.nameLbl = [UILabel labelWithFrame:CGRectMake( self.coverImageV.xx + 13, 15, kScreenWidth - self.coverImageV.xx - 13, 10) textAligment:NSTextAlignmentLeft backgroundColor:[UIColor clearColor] font:[UIFont secondFont] textColor:[UIColor zh_textColor]];
...
- (void)setGoods:(GoodModel *)goods {
    ...
    NSString *urlStr = [goods.advPic convertImageUrl];
...
//    self.priceLbl.text = [TLCurrencyHelper totalPriceWithQBB:_goods.qbb GWB:_goods.gwb RMB:_goods.rmb];
    self.priceLbl.text = [TLCurrencyHelper totalPriceWithQBB:[_goods QBB] GWB:[_goods GWB] RMB:[_goods RMB]];
