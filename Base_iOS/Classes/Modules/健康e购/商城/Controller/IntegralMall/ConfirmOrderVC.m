...
- (void)viewDidLoad {
    ...
    if (self.type == ZHIMBuyTypeSingle) { //---单买
        ...
        self.totalPriceLbl.text = [NSString stringWithFormat:@"%@ 积分", [[goods.currentParameterPriceRMB stringValue] convertToRealMoney]];
        ...
        self.totalPriceLbl.text = [NSString stringWithFormat:@"%@ 积分", [totalPrice convertToRealMoney]];
    }
        ...
        payVC.paySucces = ^(){
            ...
            dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                ...
                for (UIViewController *vc in self.navigationController.viewControllers) {
                    ...
                    if ([vc isKindOfClass:[IntegralGoodDetailVC class]]) {
...
- (UIButton *)buyBtn {
    ...
    if (!_buyBtn) {
        ...
        _buyBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 49) title:@"立即兑换" backgroundColor:kAppCustomMainColor];
...
- (void)setNOAddressUI {
    ...
    //
//    UILabel *hintLbl = [UILabel labelWithFrame:CGRectMake(0, 0, kScreenWidth/2.0 + 3, 20) textAligment:NSTextAlignmentRight
//                               backgroundColor:[UIColor whiteColor]
//                                          font:FONT(13)
//                                     textColor:[UIColor zh_textColor]];
