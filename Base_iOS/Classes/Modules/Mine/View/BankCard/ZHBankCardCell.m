...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.backgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 10, kScreenWidth - 30, 130)];
        ...
        //
        self.bankNameLbl = [UILabel labelWithFrame:CGRectMake(self.bankLogoImageV.xx + 15, 30, kScreenWidth - self.bankLogoImageV.xx - 15 , 30) textAligment:NSTextAlignmentLeft backgroundColor:[UIColor clearColor] font:FONT(16) textColor:[UIColor whiteColor]];
        [self.backgroundImageView addSubview:self.bankNameLbl];
        self.bankNameLbl.height = [FONT(16) lineHeight];
        
        //
        self.typeLbl = [UILabel labelWithFrame:CGRectMake(self.bankNameLbl.x, self.bankNameLbl .yy + 1, kScreenWidth - self.bankLogoImageV.xx - 15 , 30) textAligment:NSTextAlignmentLeft backgroundColor:[UIColor clearColor] font:FONT(14) textColor:[UIColor whiteColor]];
        self.typeLbl.height = [FONT(14) lineHeight];
        [self.backgroundImageView addSubview:self.typeLbl];
        
        //
        self.bankNumLbl = [UILabel labelWithFrame:CGRectMake(self.bankNameLbl.x, self.typeLbl.yy + 15, kScreenWidth - self.bankNameLbl.x , 30) textAligment:NSTextAlignmentLeft backgroundColor:[UIColor clearColor] font:FONT(20) textColor:[UIColor whiteColor]];
